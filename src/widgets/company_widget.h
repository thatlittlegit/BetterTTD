...
enum CompanyWidgets {
	...
	WID_C_BUY_1SHARE,                 ///< Button to buy a share.
	WID_C_BUY_10SHARE,                ///< Button to buy ten shares.
	WID_C_SELL_1SHARE,                ///< Button to sell a share.
	WID_C_SELL_10SHARE,               ///< Button to sell ten shares.
